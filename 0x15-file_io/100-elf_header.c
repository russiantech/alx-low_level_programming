...
/**
 * check_elf - validates/checks if it is an elf file.
 * @e_ident: pointer to elf  magic nums array
 *
 * Description:if file is'nt  elf file - exit code 98.
 */
 ...
 * @e_ident: pointer to array containing the elf magic nums.
 *
 ...
 * @e_ident: pointer to an array containing this elf class.
 */
 ...
 * @e_entry: adrs of the ELF entry point.
 * @e_ident: pointer to an array containing the ELF class.
 */
 ...
 *
 * Description: exit code 98 if unable to close it
 */
...
/**
 * main - shows info that's in ELF header at the start of ELF file
